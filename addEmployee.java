...
public class addEmployee extends JFrame implements ActionListener {
    JTextField tfname,tfage,tfphone,tfemail,tfsalary;
    ...
    addEmployee(){
        ...
        String str[] = { "Front Desk Clerks " , "Porters" , "HouseKeeping" , "Kitchen stuff", "Room Service " , "Chefs" , "Waiter/Waitress","Manager" ,"Accountant" };
        cbjob = new JComboBox(str);
        cbjob.setBounds(200,180,150,30);
        cbjob.setBackground(Color.cyan);
        add(cbjob);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("images/im.jpg"));
